    ...
    return (
        <div className='max-w-[1126px] mx-auto'>
            ...
            <div className='flex flex-col justify-center items-center mt-6'>
                <h1 className='text-2xl sm:text-3xl font-bold'>Our Categories</h1>
                <h2 className='text-sm sm:text-lg font-semibold mt-2'>More Food...More Variety...More Fun</h2>
            </div>

            {/* Responsive grid layout */}
            <div className='grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 gap-y-11 w-11/12 mx-auto mt-[25px]'>
                {
                    Image.map((ele, index) => {
                        return (
                            <div key={index} className='flex flex-col justify-center items-center'>
                                <img src={ele.imgsrc} 
                                     className='w-[150px] h-[150px] sm:w-[200px] sm:h-[200px] md:w-[220px] md:h-[220px] lg:w-[228px] lg:h-[228px] rounded-xl' 
                                     alt={ele.text} />
                                <p className='text-lg sm:text-xl md:text-2xl mt-2'>{ele.text}</p>
                            </div>
                        );
                    })
                }
